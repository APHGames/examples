...
export class GridMap {
	...
	getNeighbors(pos: Vector): Array<Vector> {
	    ...
	    if (this.mapType === MAP_TYPE_TILE) {
	        ...
	        if (this.isInside(n1) && !this.obstructions.has(this.indexMapper(n1))) {
	            output.push(n1);
	        }
	        if (this.isInside(n2) && !this.obstructions.has(this.indexMapper(n2))) {
	            output.push(n2);
	        }
	        if (this.isInside(n3) && !this.obstructions.has(this.indexMapper(n3))) {
	            output.push(n3);
	        }
	        if (this.isInside(n4) && !this.obstructions.has(this.indexMapper(n4))) {
	            output.push(n4);
	        }
	        ...
	        if (this.isInside(west) && !this.obstructions.has(this.indexMapper(west))) {
	            output.push(west);
	        }
	        if (this.isInside(east) && !this.obstructions.has(this.indexMapper(east))) {
	            output.push(east);
	        }
	        if (this.isInside(north) && !this.obstructions.has(this.indexMapper(north))) {
	            output.push(north);
	        }
	        if (this.isInside(south) && !this.obstructions.has(this.indexMapper(south))) {
	            output.push(south);
	        }
	        if (this.isInside(northWest) && !this.obstructions.has(this.indexMapper(northWest))) {
	            output.push(northWest);
	        }
	        if (this.isInside(southEast) && !this.obstructions.has(this.indexMapper(southEast))) {
	            output.push(southEast);
	        }
	        if (this.isInside(northEast) && !this.obstructions.has(this.indexMapper(northEast))) {
	            output.push(northEast);
	        }
	        if (this.isInside(southWest) && !this.obstructions.has(this.indexMapper(southWest))) {
	            output.push(southWest);
	        }
	    }
