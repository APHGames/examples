...
export class Tetris extends ECSExample {
	...
	async load() {
		...
		await loadAssets([
			{ alias: Assets.FONT_DOS_TEXTURE, src: `${getBaseUrl()}/assets/games/tetris/dos.png` },
		]);
		await loadTextAsset(Assets.FONT_DOS, `${getBaseUrl()}/assets/games/tetris/dos.fnt`);
		getLoadedTexture(Assets.FONT_DOS_TEXTURE).source.scaleMode = 'nearest';

		// todo refactor this
		PIXISound.add(Assets.SOUND_GAMEOVER, `${getBaseUrl()}/assets/games/tetris/snd_gameover.mp3`);
		PIXISound.add(Assets.SOUND_LEVELUP, `${getBaseUrl()}/assets/games/tetris/snd_levelup.mp3`);
		PIXISound.add(Assets.SOUND_MOVEDOWN, `${getBaseUrl()}/assets/games/tetris/snd_movedown.mp3`);
		PIXISound.add(Assets.SOUND_PLACE, `${getBaseUrl()}/assets/games/tetris/snd_place.mp3`);
		PIXISound.add(Assets.SOUND_ROTATE, `${getBaseUrl()}/assets/games/tetris/snd_rotate.mp3`);
		PIXISound.add(Assets.SOUND_ROWCLEAR, `${getBaseUrl()}/assets/games/tetris/snd_rowclear.mp3`);
		PIXISound.add(Assets.MUSIC, `${getBaseUrl()}/assets/games/tetris/music.mp3`);
