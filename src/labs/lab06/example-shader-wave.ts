...
export class ExampleShaderWave {
  ...
  loader
  .reset()
  .add('noise_vert', './assets/lab06/shaders/wave.vert')
  .add('noise_frag', './assets/lab06/shaders/wave.frag')
  .load(() => {
...
new ExampleShaderWave(<HTMLCanvasElement>document.getElementById('gameCanvas'));